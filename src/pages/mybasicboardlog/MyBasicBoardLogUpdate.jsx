...
function MyBasicBoardLogUpdate(props) {
   ...
   return (
      <>
            ...
            <ul>
               ...
               <div className={styles.edit__img__box2}>
                  <div className={styles.edit__img__item}>
                     <button className={styles.edit__img__btn}>
                        <span class="material-symbols-outlined">remove</span>
                     </button>
                     <img
                        src="/images/main_slide_1.jpg" alt="사진"
         ...
         <div className={boardlog.write_button_box}>                
            <div>
               <button className={boardlog.board_write}>수정</button>    
...
export default MyBasicBoardLogUpdate;
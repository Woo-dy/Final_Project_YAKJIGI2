...
function MyBasicBoardCounselDetail(props) {
   ...
   const proCounselListBtn = (event) => {
      ...
      window.location.href = '/mybasicboardcounsel'; // 클릭 시에만 이동
   };

   const proCounselUpdateBtn = (event) => {
      event.preventDefault(); // 기본 동작 방지
      window.location.href = '/mybasicboardcounselupdate'; // 클릭 시에만 이동
   };
...
export default MyBasicBoardCounselDetail;
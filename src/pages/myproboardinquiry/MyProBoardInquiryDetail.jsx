...
function MyProBoardInquiryDetail(props) {
   ...
   const proCounselListBtn = (event) => {
      ...
      window.location.href = '/myproboardinquiry'; // 클릭 시에만 이동
   };

   const proCounselUpdateBtn = (event) => {
      event.preventDefault(); // 기본 동작 방지
      window.location.href = '/myproboardinquiryupdate'; // 클릭 시에만 이동
   };
...
export default MyProBoardInquiryDetail;
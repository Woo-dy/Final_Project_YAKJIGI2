...
function MyBasicBoardInquiryDetail(props) {
   ...
   const proCounselListBtn = (event) => {
      ...
      window.location.href = '/mybasicboardinquiry'; // 클릭 시에만 이동
   };

   const proCounselUpdateBtn = (event) => {
      event.preventDefault(); // 기본 동작 방지
      window.location.href = '/mybasicboardinquiryupdate'; // 클릭 시에만 이동
   };
   
   // 한 페이지 내에 페이지가 여러개 추가될 시 버튼 활성화  
   const activeClass = ['/mybasicboardinquiry',
                        '/mybasicboardinquirywrite',
                        '/mybasicboardinquiryupdate',
                        '/mybasicboardinquirydetail' ].includes(location.pathname) ? 
                        styles.boardActive : '';
      ...
      <>
         ...
         <div className={styles.my__board__tabmenu}>
            <ul>
               ...
               <li className={['/mybasicboardinquiry', 
                              '/mybasicboardinquirywrite',
                              '/mybasicboardinquiryupdate',
         ...
         <div className={board.board_container}>
            ...
            <div>               
               <div className={board.detail_button_box}>
                  <button className={board.cancle} onClick={proCounselListBtn}>목록</button>  
                  <form method="post">  
                     {/* <input type="hidden" name="cPage" value="${cPage}" /> 
                     <input type="hidden" name="idxn_idx" value="${gvo.idxn_idx}" /> 
                  ...
                  <span>
                     <button className={board.detail_write} onClick={proCounselUpdateBtn}>수정</button>   
...
export default MyBasicBoardInquiryDetail;